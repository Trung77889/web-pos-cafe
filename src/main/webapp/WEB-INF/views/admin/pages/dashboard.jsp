...
<div class="sidebar">
    ...
    <nav class="navigation">
        <ul>
            ...
            <li><a href="#product"><i class="fas fa-box-open"></i>
                <span>Sản phẩm</span>
            </a></li>
            <li><a href="#order"><i class="fas fa-shopping-cart"></i>
                <span>Đơn hàng</span>
            </a></li>
            <li><a href="#revenue"><i class="fas fa-chart-line"></i>
                <span>Doanh thu</span>
            </a></li>
            <li><a href="#account"><i class="fas fa-user-circle"></i>
                <span>Tài khoản</span>
            </a></li>
            <li><a href="#staff"><i class="fas fa-users-cog"></i>
                <span>Nhân viên</span>
            </a></li>
            <li><a href="#log"><i class="fas fa-clipboard-list"></i>
                <span>Nhật ký</span>
            </a></li>
        </ul>
    </nav>
            ...
            <table class="data-table">
                ...
                <c:forEach var="p" items="${productsList}">
                    <tr
                            ...
                            data-unit="${p.unit}"
                            data-image-src="${empty p.image ? 'https://picsum.photos/50' : p.image}"
                            data-hide="${p.active == 0}"
                    >
                        <td>#${p.id}</td>

                        <td>
                            <img src="${empty p.image ? 'https://picsum.photos/50' : p.image}"
                                 alt="${p.name}">
                        </td>
            ...
            <div class="modal-body">
                <form id="create-product-form" class="product-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="newInventoryUnit" placeholder="Nhập đơn vị">
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="product-form">
                    ...
                    <div class="form-group">
                        <label>Đơn vị</label>
                        <input type="text" data-fill="unit" placeholder="Nhập đơn vị">
                    </div>
                    <div class="form-group">
