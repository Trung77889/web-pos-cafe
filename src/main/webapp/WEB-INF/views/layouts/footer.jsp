...
<footer class="footer">
    <div class="container">
        <div class="footer-top">
            ...
            <ul class="p-0">
                ...
                <li class="d-flex gap-2 align-items-center mb-2">
                    ...
                    <p class="text-muted mb-0">
                        ${general["general.company.officeAddress"]}
        ...
        <div class="footer-end d-flex justify-content-between align-items-center">
            <p class="text-muted text-center mb-0">&copy; 2025 ${general["general.copyright"]} Zero Star Coffee</p>
