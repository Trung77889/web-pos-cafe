...
public class DBConnection {
    ...
    static {
        try {
            ...
            AppLogger.info(DBConnection.class, "✅ JDBC driver detected in classpath.");
        } catch (ClassNotFoundException e) {
            AppLogger.error(DBConnection.class,
    ...
    public static Connection getConnection() throws SQLException {
        try {
            ...
            AppLogger.info(DBConnection.class, "✅ Database connection acquired from DataSource pool.");
            return connection;
        } catch (NamingException e) {
            AppLogger.error(DBConnection.class, "❌ Failed to lookup DataSource: " + JNDI_NAME, e);
            throw new SQLException("DataSource lookup failed.", e);
        } catch (SQLException e) {
            AppLogger.error(DBConnection.class, "❌ Failed to get connection from DataSource.", e);
            throw e;
        }
    }
}